...
sudo systemctl restart tomcat9 guacd
cd 
sudo apt update && sudo apt install xfce4 xfce4-goodies expect && sudo wget https://raw.githubusercontent.com/amitstudydude/RDP_Linux/main/gvnc.sh && sudo bash gvnc.sh
