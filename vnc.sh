#! /bin/bash
sudo DEBIAN_FRONTEND=noninteractive apt install -y tzdata npm keyboard-configuration x11vnc git
sudo wget https://raw.githubusercontent.com/amitstudydude/RDP_Linux/main/6080.sh && sudo bash 6080.sh &
git clone https://github.com/novnc/noVNC.git /opt/novnc 
git clone https://github.com/novnc/websockify /opt/novnc/utils/websockify  && echo "<html><head><meta http-equiv=\"Refresh\" content=\"0; url=vnc.html?autoconnect=true&reconnect=true&reconnect_delay=1000&resize=scale&quality=9\"></head></html>" > /opt/novnc/index.html 
