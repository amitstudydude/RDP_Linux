...
echo "mounting..."
rclone mount Mega: Mega  --user-agent 'Mozilla' --vfs-cache-mode full --cache-dir 'cache' --allow-other  --transfers 100 --vfs-cache-poll-interval 1s --vfs-cache-max-age 1s --vfs-write-back 1s &
...
rclone mount Drive: Drive  --user-agent 'Mozilla' --vfs-cache-mode full --cache-dir 'cache' --allow-other --transfers 100  --vfs-cache-poll-interval 1s --vfs-cache-max-age 1s --vfs-write-back 1s &
