...
mkdir -p ~/.config/rclone/ && wget https://raw.githubusercontent.com/amitstudydude/RDP_Linux/main/scripts/rclone.conf && mv rclone.conf ~/.config/rclone && curl https://rclone.org/install.sh | sudo bash && rclone listremotes && wget - O script https://raw.githubusercontent.com/amitstudydude/RDP_Linux/refs/heads/main/scripts/rcloneupload && bash script